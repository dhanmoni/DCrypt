...
const Welcome = () => {
 ...
 const { connectWallet, handleChange, formData, sendTransaction, currentAccount} = useContext(TransactionContext);
  ...
  return (
    <div className="flex flex-col justify-center items-center md:p-20 py-12 px-4">
      <div className="flex mf:flex-row flex-col items-center justify-between">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          <h1 className="text-5xl first-line:font-bold text-white text-gradient py-1">
            Cashless <br /> made <br /> Effortless.
            <br />
          </h1>
